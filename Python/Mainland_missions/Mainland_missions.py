...
directory = os.path.join("Python", "Mainland_missions")
file_path = os.path.join(directory, "mission_status.txt")
...
# Sort missions alphabetically disregarding case sensitivity
...
num_columns = 3
num_rows = (len(missions) + num_columns - 1) // num_columns
